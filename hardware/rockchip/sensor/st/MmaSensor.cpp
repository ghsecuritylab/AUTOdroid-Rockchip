...
/*
    ...
    angleData[1] = ( (angle.z) * ACCELERATION_RATIO_ANDROID_TO_HW);
    angleData[2] = ( (angle.x) * ACCELERATION_RATIO_ANDROID_TO_HW);

    accData[0] = ( (acc.y) * ACCELERATION_RATIO_ANDROID_TO_HW);
    accData[1] = ( (acc.z) * ACCELERATION_RATIO_ANDROID_TO_HW);
    accData[2] = ( (acc.x) * ACCELERATION_RATIO_ANDROID_TO_HW);
*/
