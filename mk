...
build_bootloader_uboot()
{
	...
	cp -v ${BS_DIR_UBOOT}/RK3288UbootLoader_V2.30.10.bin ${BS_DIR_RELEASE}

	echo "^_^ uboot path: ${BS_DIR_RELEASE}/RK3288UbootLoader_V2.30.10.bin"
	return 0
}
...
build_system()
{
	...
	# Generating image
	${BS_DIR_TOOLS}/rkImageMaker -RK32 ${BS_DIR_RELEASE}/RK3288UbootLoader_V2.30.10.bin ${BS_DIR_RELEASE}/temp.img ${BS_DIR_RELEASE}/update.img -os_type:androidos || return 1;
