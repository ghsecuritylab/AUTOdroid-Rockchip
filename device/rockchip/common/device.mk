...
ifeq ($(strip $(BOARD_GPS_TYPE)), BCM4752)
PRODUCT_COPY_FILES += \
    device/rockchip/common/ap6452_gps/gps.conf:system/etc/gps.conf \
    device/rockchip/common/ap6452_gps/glgps:system/bin/glgps \
    device/rockchip/common/ap6452_gps/gpsconfig.xml:system/etc/gps/gpsconfig.xml \
    device/rockchip/common/ap6452_gps/gps.default.so:system/lib/hw/gps.default.so \
    device/rockchip/common/ap6452_gps/flp.default.so:system/lib/hw/flp.default.so
endif
endif
